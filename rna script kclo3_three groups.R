################################################################################
### Learn EdgeR and RNA analysis
### setwd("C:/Users/pimonrat.t/OneDrive - Chiang Mai University/Research project/Suparat/RNA")
################################################################################
################################################################################
...
count <- read.csv("ALL_KCLO3_3 groups_15 samples.csv", header = T)
str(count)

matrix <- as.matrix(count[,-1])
head(matrix)
groups <- c("GrC918910","GrC918910","GrC918910", "GrC918910",
            "GrC918910", "Gr456712", "Gr456712","Gr456712",
            "Gr456712", "Gr456712", "Gr1113141617", "Gr1113141617", 
            "Gr1113141617", "Gr1113141617", "Gr1113141617")
...
levels(groups) ## "Gr1113141617" "Gr456712" "GrC918910" 
...
#### Classic approach
################################################################################
et12 <- exactTest(d1, pair=c(1,2)) # compare Gr1113141617 and Gr456712
et13 <- exactTest(d1, pair=c(1,3)) # compare Gr1113141617 and GrC918910
et23 <- exactTest(d1, pair=c(2,3)) # compare Gr456712 and GrC918910

topGr1113141617.Gr456712 <- topTags(et12)
topTags(et12, n=15)
...
my.contrasts <- makeContrasts(Gr1113141617vsGr456712 = Gr1113141617-Gr456712, 
                              Gr1113141617vsGrC918910 = Gr1113141617-GrC918910, 
                              Gr456712vsGrC918910 = Gr456712-GrC918910, 
                              levels = design.mat)


qlf.Gr1113141617Gr456712 <- glmQLFTest(fit, contrast = my.contrasts[,"Gr1113141617vsGr456712"])
topTags(qlf.Gr1113141617Gr456712)
all.Gr1113141617Gr456712 <- topTags(qlf.Gr1113141617Gr456712, n = Inf)
up.Gr1113141617Gr456712 <- head(all.Gr1113141617Gr456712[all.Gr1113141617Gr456712$table$logFC > 0,], n= 20L)
write.csv(up.Gr1113141617Gr456712 , "Gr1113141617 vs Gr456712.csv")
is.de <- decideTestsDGE(qlf.Gr1113141617Gr456712)
summary(is.de)

plotMD(qlf.Gr1113141617Gr456712, status = is.de, values=c(1,-1), col=c("red","blue"),
       legend="topright")

### try to reduce the number of expressed gene
tr <- glmTreat(fit, contrast = my.contrasts[,"Gr1113141617vsGr456712"], 
               lfc=log2(1.5))
topTags(tr)
...
################################################################################
qlf.GGr1113141617Gr456712.tr <- glmQLFTest(tr, contrast = my.contrasts[,"Gr1113141617vsGr456712"])
topTags(qlf.Gr1113141617Gr456712)
...
qlf.Gr1113141617GrC918910 <- glmQLFTest(fit, contrast = my.contrasts[,"Gr1113141617vsGrC918910"])
all.Gr1113141617GrC918910 <- topTags(qlf.Gr1113141617GrC918910, n = Inf)
up.Gr1113141617GrC918910 <- head(all.Gr1113141617GrC918910[all.Gr1113141617GrC918910$table$logFC > 0,], n= 20L)
write.csv(up.Gr1113141617GrC918910, "Gr1113141617 vs GrC918910.csv")

qlf.Gr456712GrC918910 <- glmQLFTest(fit, contrast = my.contrasts[,"Gr456712vsGrC918910"])
all.Gr456712GrC918910 <- topTags(qlf.Gr456712GrC918910, n = Inf)
up.Gr456712GrC918910 <- head(all.Gr456712GrC918910[all.Gr456712GrC918910$table$logFC > 0,], n= 20L)
write.csv(up.Gr456712GrC918910 , "Gr456712 vs GrC918910.csv")


################################################################################
## Make a list of all results
################################################################################
DEresult.list <- list(all.Gr1113141617Gr456712, 
                      all.Gr1113141617GrC918910, 
                      all.Gr456712GrC918910)

names(DEresult.list) <- c('all.Gr1113141617Gr456712', 'all.Gr1113141617GrC918910',
                          'all.Gr456712GrC91891')

file.name <- c('all.Gr1113141617Gr456712', 'all.Gr1113141617GrC918910',
               'all.Gr456712GrC918910')
...
################################################################################
head(all.Gr1113141617Gr456712)

all.Gr1113141617Gr456712.df <- as.data.frame(all.Gr1113141617Gr456712)
all.Gr1113141617Gr456712.df$diffexpressed <- "No"
all.Gr1113141617Gr456712.df$diffexpressed[all.Gr1113141617Gr456712.df$logFC > 1 & 
                             all.Gr1113141617Gr456712.df$PValue < 0.05] <- "Up"
all.Gr1113141617Gr456712.df$diffexpressed[all.Gr1113141617Gr456712.df$logFC < -1 & 
                             all.Gr1113141617Gr456712.df$PValue < 0.05] <- "Down"
all.Gr1113141617Gr456712.df$diffexpressed <- as.factor(all.Gr1113141617Gr456712.df$diffexpressed)
...
names(volcano.dflist) <- c('all.Gr1113141617Gr456712', 
                           'all.Gr1113141617GrC918910',
                           'all.Gr456712GrC918910')
...
names(volcano.plotlist) <- c('all.Gr1113141617Gr456712', 
                             'all.Gr1113141617GrC918910',
                             'all.Gr456712GrC918910')
################################################################################
...
################################################################################
setwd("Desktop/R Script_15May2023")
...
################################################################################
logCPM1 <- cpm(d, prior.count = 4, log = TRUE) #prior count = 2 to avoid log 0
rownames(logCPM1) <- d$genes$genes 
colnames(logCPM1) <- paste(d$samples$group, 1:5, sep="-")
head(logCPM1)
...
heatmap.2(logCPM1, col = col.pan, Rowv = TRUE, scale = "none",
          ...
          main = "Heat map across 3 groups_15 samples")
par(cex.main = 1) 
